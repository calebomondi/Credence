...
export interface AvmProve {
  inputs: Uint8Array;
}

export interface AvmVerify {
  proof: Uint8Array[];
  publicInputs: Uint8Array;
}

export interface AvmCheckCircuit {
  inputs: Uint8Array;
}
...
export interface ChonkVerifyFromFields {
  proof: Uint8Array[];
  vk: Uint8Array;
}
...
export interface ChonkBatchVerifierStart {
  vks: Uint8Array[];
  numCores: number;
  batchSize: number;
  fifoPath: string;
...
export interface ChonkBatchVerifierQueue {
  requestId: number;
  vkIndex: number;
  proofFields: Uint8Array[];
}

export interface ChonkBatchVerifierStop {
...
export interface AvmProveResponse {
  proof: Uint8Array[];
  stats: AvmStat[];
}

export interface AvmVerifyResponse {
  verified: boolean;
}

export interface AvmCheckCircuitResponse {
  passed: boolean;
  stats: AvmStat[];
}
...
export interface ChonkVerifyFromFieldsResponse {
  valid: boolean;
}
...
export interface ChonkBatchVerifierStartResponse {

}

export interface ChonkBatchVerifierQueueResponse {

}

export interface ChonkBatchVerifierStopResponse {
...
interface MsgpackAvmProve {
  inputs: Uint8Array;
}

interface MsgpackAvmVerify {
  proof: Uint8Array[];
  public_inputs: Uint8Array;
}

interface MsgpackAvmCheckCircuit {
  inputs: Uint8Array;
}
...
interface MsgpackChonkVerifyFromFields {
  proof: Uint8Array[];
  vk: Uint8Array;
}
...
interface MsgpackChonkBatchVerifierStart {
  vks: Uint8Array[];
  num_cores: number;
  batch_size: number;
  fifo_path: string;
...
interface MsgpackChonkBatchVerifierQueue {
  request_id: number;
  vk_index: number;
  proof_fields: Uint8Array[];
}

interface MsgpackChonkBatchVerifierStop {
...
interface MsgpackAvmProveResponse {
  proof: Uint8Array[];
  stats: MsgpackAvmStat[];
}

interface MsgpackAvmVerifyResponse {
  verified: boolean;
}

interface MsgpackAvmCheckCircuitResponse {
  passed: boolean;
  stats: MsgpackAvmStat[];
}
...
interface MsgpackChonkVerifyFromFieldsResponse {
  valid: boolean;
}
...
interface MsgpackChonkBatchVerifierStartResponse {

}

interface MsgpackChonkBatchVerifierQueueResponse {

}

interface MsgpackChonkBatchVerifierStopResponse {
...
export function toAvmStat(o: MsgpackAvmStat): AvmStat {
  if (o.name === undefined) { throw new Error("Expected name in AvmStat deserialization"); }
  if (o.value_ms === undefined) { throw new Error("Expected value_ms in AvmStat deserialization"); };
  return {
    name: o.name,
    valueMs: o.value_ms,
  };
...
export function toAvmProve(o: MsgpackAvmProve): AvmProve {
  if (o.inputs === undefined) { throw new Error("Expected inputs in AvmProve deserialization"); };
  return {
    inputs: o.inputs,
  };
}

export function toAvmVerify(o: MsgpackAvmVerify): AvmVerify {
  if (o.proof === undefined) { throw new Error("Expected proof in AvmVerify deserialization"); }
  if (o.public_inputs === undefined) { throw new Error("Expected public_inputs in AvmVerify deserialization"); };
  return {
    proof: o.proof,
...
export function toAvmCheckCircuit(o: MsgpackAvmCheckCircuit): AvmCheckCircuit {
  if (o.inputs === undefined) { throw new Error("Expected inputs in AvmCheckCircuit deserialization"); };
  return {
    inputs: o.inputs,
  };
}
...
export function toChonkComputeVk(o: MsgpackChonkComputeVk): ChonkComputeVk {
  ...
  if (o.use_zk_flavor === undefined) { throw new Error("Expected use_zk_flavor in ChonkComputeVk deserialization"); };
  return {
    circuit: toCircuitInputNoVK(o.circuit),
    useZkFlavor: o.use_zk_flavor,
  };
}
...
export function toChonkVerifyFromFields(o: MsgpackChonkVerifyFromFields): ChonkVerifyFromFields {
  if (o.proof === undefined) { throw new Error("Expected proof in ChonkVerifyFromFields deserialization"); }
  if (o.vk === undefined) { throw new Error("Expected vk in ChonkVerifyFromFields deserialization"); };
  return {
    proof: o.proof,
    vk: o.vk,
  };
...
export function toChonkCheckPrecomputedVk(o: MsgpackChonkCheckPrecomputedVk): ChonkCheckPrecomputedVk {
  ...
  if (o.use_zk_flavor === undefined) { throw new Error("Expected use_zk_flavor in ChonkCheckPrecomputedVk deserialization"); };
  return {
    circuit: toCircuitInput(o.circuit),
    useZkFlavor: o.use_zk_flavor,
  };
...
export function toSchnorrConstructSignature(o: MsgpackSchnorrConstructSignature): SchnorrConstructSignature {
  if (o.message_field === undefined) { throw new Error("Expected message_field in SchnorrConstructSignature deserialization"); }
  if (o.private_key === undefined) { throw new Error("Expected private_key in SchnorrConstructSignature deserialization"); };
  return {
    messageField: o.message_field,
    privateKey: o.private_key,
  };
}

export function toSchnorrVerifySignature(o: MsgpackSchnorrVerifySignature): SchnorrVerifySignature {
  if (o.message_field === undefined) { throw new Error("Expected message_field in SchnorrVerifySignature deserialization"); }
...
export function toChonkBatchVerifierStart(o: MsgpackChonkBatchVerifierStart): ChonkBatchVerifierStart {
  if (o.vks === undefined) { throw new Error("Expected vks in ChonkBatchVerifierStart deserialization"); }
  if (o.num_cores === undefined) { throw new Error("Expected num_cores in ChonkBatchVerifierStart deserialization"); }
  if (o.batch_size === undefined) { throw new Error("Expected batch_size in ChonkBatchVerifierStart deserialization"); }
  if (o.fifo_path === undefined) { throw new Error("Expected fifo_path in ChonkBatchVerifierStart deserialization"); };
  return {
    vks: o.vks,
    numCores: o.num_cores,
    batchSize: o.batch_size,
    fifoPath: o.fifo_path,
  };
}

export function toChonkBatchVerifierQueue(o: MsgpackChonkBatchVerifierQueue): ChonkBatchVerifierQueue {
  if (o.request_id === undefined) { throw new Error("Expected request_id in ChonkBatchVerifierQueue deserialization"); }
  if (o.vk_index === undefined) { throw new Error("Expected vk_index in ChonkBatchVerifierQueue deserialization"); }
  if (o.proof_fields === undefined) { throw new Error("Expected proof_fields in ChonkBatchVerifierQueue deserialization"); };
  return {
    requestId: o.request_id,
    vkIndex: o.vk_index,
    proofFields: o.proof_fields,
  };
}

export function toChonkBatchVerifierStop(o: MsgpackChonkBatchVerifierStop): ChonkBatchVerifierStop {
  return {};
}
...
export function toAvmProveResponse(o: MsgpackAvmProveResponse): AvmProveResponse {
  if (o.proof === undefined) { throw new Error("Expected proof in AvmProveResponse deserialization"); }
  if (o.stats === undefined) { throw new Error("Expected stats in AvmProveResponse deserialization"); };
  return {
    proof: o.proof,
    stats: o.stats.map((v: any) => toAvmStat(v)),
  };
}

export function toAvmVerifyResponse(o: MsgpackAvmVerifyResponse): AvmVerifyResponse {
  if (o.verified === undefined) { throw new Error("Expected verified in AvmVerifyResponse deserialization"); };
  return {
    verified: o.verified,
  };
}

export function toAvmCheckCircuitResponse(o: MsgpackAvmCheckCircuitResponse): AvmCheckCircuitResponse {
  if (o.passed === undefined) { throw new Error("Expected passed in AvmCheckCircuitResponse deserialization"); }
  if (o.stats === undefined) { throw new Error("Expected stats in AvmCheckCircuitResponse deserialization"); };
  return {
    passed: o.passed,
    stats: o.stats.map((v: any) => toAvmStat(v)),
  };
...
export function toChonkVerifyFromFieldsResponse(o: MsgpackChonkVerifyFromFieldsResponse): ChonkVerifyFromFieldsResponse {
  if (o.valid === undefined) { throw new Error("Expected valid in ChonkVerifyFromFieldsResponse deserialization"); };
  return {
    valid: o.valid,
  };
}
...
export function toSrsInitSrsResponse(o: MsgpackSrsInitSrsResponse): SrsInitSrsResponse {
  if (o.points_buf === undefined) { throw new Error("Expected points_buf in SrsInitSrsResponse deserialization"); };
  return {
    pointsBuf: o.points_buf,
  };
}

export function toChonkBatchVerifierStartResponse(o: MsgpackChonkBatchVerifierStartResponse): ChonkBatchVerifierStartResponse {
  return {};
}

export function toChonkBatchVerifierQueueResponse(o: MsgpackChonkBatchVerifierQueueResponse): ChonkBatchVerifierQueueResponse {
  return {};
}

export function toChonkBatchVerifierStopResponse(o: MsgpackChonkBatchVerifierStopResponse): ChonkBatchVerifierStopResponse {
  return {};
}
...
export function fromAvmStat(o: AvmStat): MsgpackAvmStat {
  if (o.name === undefined) { throw new Error("Expected name in AvmStat serialization"); }
  if (o.valueMs === undefined) { throw new Error("Expected valueMs in AvmStat serialization"); };
  return {
  name: o.name,
  value_ms: o.valueMs,
  };
...
export function fromAvmProve(o: AvmProve): MsgpackAvmProve {
  if (o.inputs === undefined) { throw new Error("Expected inputs in AvmProve serialization"); };
  return {
  inputs: o.inputs,
  };
}

export function fromAvmVerify(o: AvmVerify): MsgpackAvmVerify {
  if (o.proof === undefined) { throw new Error("Expected proof in AvmVerify serialization"); }
  if (o.publicInputs === undefined) { throw new Error("Expected publicInputs in AvmVerify serialization"); };
  return {
  proof: o.proof,
...
export function fromAvmCheckCircuit(o: AvmCheckCircuit): MsgpackAvmCheckCircuit {
  if (o.inputs === undefined) { throw new Error("Expected inputs in AvmCheckCircuit serialization"); };
  return {
  inputs: o.inputs,
  };
}
...
export function fromChonkComputeVk(o: ChonkComputeVk): MsgpackChonkComputeVk {
  ...
  if (o.useZkFlavor === undefined) { throw new Error("Expected useZkFlavor in ChonkComputeVk serialization"); };
  return {
  circuit: fromCircuitInputNoVK(o.circuit),
  use_zk_flavor: o.useZkFlavor,
  };
}
...
export function fromChonkVerifyFromFields(o: ChonkVerifyFromFields): MsgpackChonkVerifyFromFields {
  if (o.proof === undefined) { throw new Error("Expected proof in ChonkVerifyFromFields serialization"); }
  if (o.vk === undefined) { throw new Error("Expected vk in ChonkVerifyFromFields serialization"); };
  return {
  proof: o.proof,
  vk: o.vk,
  };
...
export function fromChonkCheckPrecomputedVk(o: ChonkCheckPrecomputedVk): MsgpackChonkCheckPrecomputedVk {
  ...
  if (o.useZkFlavor === undefined) { throw new Error("Expected useZkFlavor in ChonkCheckPrecomputedVk serialization"); };
  return {
  circuit: fromCircuitInput(o.circuit),
  use_zk_flavor: o.useZkFlavor,
  };
...
export function fromSchnorrConstructSignature(o: SchnorrConstructSignature): MsgpackSchnorrConstructSignature {
  if (o.messageField === undefined) { throw new Error("Expected messageField in SchnorrConstructSignature serialization"); }
  if (o.privateKey === undefined) { throw new Error("Expected privateKey in SchnorrConstructSignature serialization"); };
  return {
  message_field: o.messageField,
  private_key: o.privateKey,
  };
}

export function fromSchnorrVerifySignature(o: SchnorrVerifySignature): MsgpackSchnorrVerifySignature {
  if (o.messageField === undefined) { throw new Error("Expected messageField in SchnorrVerifySignature serialization"); }
...
export function fromChonkBatchVerifierStart(o: ChonkBatchVerifierStart): MsgpackChonkBatchVerifierStart {
  if (o.vks === undefined) { throw new Error("Expected vks in ChonkBatchVerifierStart serialization"); }
  if (o.numCores === undefined) { throw new Error("Expected numCores in ChonkBatchVerifierStart serialization"); }
  if (o.batchSize === undefined) { throw new Error("Expected batchSize in ChonkBatchVerifierStart serialization"); }
  if (o.fifoPath === undefined) { throw new Error("Expected fifoPath in ChonkBatchVerifierStart serialization"); };
  return {
  vks: o.vks,
  num_cores: o.numCores,
  batch_size: o.batchSize,
  fifo_path: o.fifoPath,
  };
}

export function fromChonkBatchVerifierQueue(o: ChonkBatchVerifierQueue): MsgpackChonkBatchVerifierQueue {
  if (o.requestId === undefined) { throw new Error("Expected requestId in ChonkBatchVerifierQueue serialization"); }
  if (o.vkIndex === undefined) { throw new Error("Expected vkIndex in ChonkBatchVerifierQueue serialization"); }
  if (o.proofFields === undefined) { throw new Error("Expected proofFields in ChonkBatchVerifierQueue serialization"); };
  return {
  request_id: o.requestId,
  vk_index: o.vkIndex,
  proof_fields: o.proofFields,
  };
}

export function fromChonkBatchVerifierStop(o: ChonkBatchVerifierStop): MsgpackChonkBatchVerifierStop {
  return {};
}
...
export function fromAvmProveResponse(o: AvmProveResponse): MsgpackAvmProveResponse {
  if (o.proof === undefined) { throw new Error("Expected proof in AvmProveResponse serialization"); }
  if (o.stats === undefined) { throw new Error("Expected stats in AvmProveResponse serialization"); };
  return {
  proof: o.proof,
  stats: o.stats.map((v: any) => fromAvmStat(v)),
  };
}

export function fromAvmVerifyResponse(o: AvmVerifyResponse): MsgpackAvmVerifyResponse {
  if (o.verified === undefined) { throw new Error("Expected verified in AvmVerifyResponse serialization"); };
  return {
  verified: o.verified,
  };
}

export function fromAvmCheckCircuitResponse(o: AvmCheckCircuitResponse): MsgpackAvmCheckCircuitResponse {
  if (o.passed === undefined) { throw new Error("Expected passed in AvmCheckCircuitResponse serialization"); }
  if (o.stats === undefined) { throw new Error("Expected stats in AvmCheckCircuitResponse serialization"); };
  return {
  passed: o.passed,
  stats: o.stats.map((v: any) => fromAvmStat(v)),
  };
...
export function fromChonkVerifyFromFieldsResponse(o: ChonkVerifyFromFieldsResponse): MsgpackChonkVerifyFromFieldsResponse {
  if (o.valid === undefined) { throw new Error("Expected valid in ChonkVerifyFromFieldsResponse serialization"); };
  return {
  valid: o.valid,
  };
}
...
export function fromSrsInitSrsResponse(o: SrsInitSrsResponse): MsgpackSrsInitSrsResponse {
  if (o.pointsBuf === undefined) { throw new Error("Expected pointsBuf in SrsInitSrsResponse serialization"); };
  return {
  points_buf: o.pointsBuf,
  };
}

export function fromChonkBatchVerifierStartResponse(o: ChonkBatchVerifierStartResponse): MsgpackChonkBatchVerifierStartResponse {
  return {};
}

export function fromChonkBatchVerifierQueueResponse(o: ChonkBatchVerifierQueueResponse): MsgpackChonkBatchVerifierQueueResponse {
  return {};
}

export function fromChonkBatchVerifierStopResponse(o: ChonkBatchVerifierStopResponse): MsgpackChonkBatchVerifierStopResponse {
  return {};
}
...
export interface BbApiBase {
  avmProve(command: AvmProve): Promise<AvmProveResponse>;
  avmVerify(command: AvmVerify): Promise<AvmVerifyResponse>;
  avmCheckCircuit(command: AvmCheckCircuit): Promise<AvmCheckCircuitResponse>;
  ...
  chonkVerifyFromFields(command: ChonkVerifyFromFields): Promise<ChonkVerifyFromFieldsResponse>;
  ...
  chonkBatchVerifierStart(command: ChonkBatchVerifierStart): Promise<ChonkBatchVerifierStartResponse>;
  chonkBatchVerifierQueue(command: ChonkBatchVerifierQueue): Promise<ChonkBatchVerifierQueueResponse>;
  chonkBatchVerifierStop(command: ChonkBatchVerifierStop): Promise<ChonkBatchVerifierStopResponse>;
