...
export class AsyncApi implements BbApiBase {
  ...
  avmProve(command: AvmProve): Promise<AvmProveResponse> {
    ...
    return msgpackCall(this.backend, [["AvmProve", msgpackCommand]]).then(([variantName, result]: [string, any]) => {
  ...
  avmVerify(command: AvmVerify): Promise<AvmVerifyResponse> {
    ...
    return msgpackCall(this.backend, [["AvmVerify", msgpackCommand]]).then(([variantName, result]: [string, any]) => {
      if (variantName === 'ErrorResponse') {
        throw new BBApiException(result.message || 'Unknown error from barretenberg');
      }
  ...
  avmCheckCircuit(command: AvmCheckCircuit): Promise<AvmCheckCircuitResponse> {
    ...
    return msgpackCall(this.backend, [["AvmCheckCircuit", msgpackCommand]]).then(([variantName, result]: [string, any]) => {
      if (variantName === 'ErrorResponse') {
        throw new BBApiException(result.message || 'Unknown error from barretenberg');
      }
  ...
  chonkVerifyFromFields(command: ChonkVerifyFromFields): Promise<ChonkVerifyFromFieldsResponse> {
    ...
    return msgpackCall(this.backend, [["ChonkVerifyFromFields", msgpackCommand]]).then(([variantName, result]: [string, any]) => {
      if (variantName === 'ErrorResponse') {
        throw new BBApiException(result.message || 'Unknown error from barretenberg');
      }
  ...
  chonkBatchVerifierStart(command: ChonkBatchVerifierStart): Promise<ChonkBatchVerifierStartResponse> {
    ...
    return msgpackCall(this.backend, [["ChonkBatchVerifierStart", msgpackCommand]]).then(([variantName, result]: [string, any]) => {
      if (variantName === 'ErrorResponse') {
        throw new BBApiException(result.message || 'Unknown error from barretenberg');
      }
  ...
  chonkBatchVerifierQueue(command: ChonkBatchVerifierQueue): Promise<ChonkBatchVerifierQueueResponse> {
    ...
    return msgpackCall(this.backend, [["ChonkBatchVerifierQueue", msgpackCommand]]).then(([variantName, result]: [string, any]) => {
      if (variantName === 'ErrorResponse') {
        throw new BBApiException(result.message || 'Unknown error from barretenberg');
      }
  ...
  chonkBatchVerifierStop(command: ChonkBatchVerifierStop): Promise<ChonkBatchVerifierStopResponse> {
    ...
    return msgpackCall(this.backend, [["ChonkBatchVerifierStop", msgpackCommand]]).then(([variantName, result]: [string, any]) => {
      if (variantName === 'ErrorResponse') {
        throw new BBApiException(result.message || 'Unknown error from barretenberg');
      }
